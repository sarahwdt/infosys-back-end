<template>
  <div class="w3-modal w3-container" style="display: block;">
    <div v-if="!loading" class="w3-modal-content">
      <header class="w3-container w3-xxlarge w3-teal"><h2>Изменение данных</h2></header>
      ...
      <form class="w3-container w3-padding-bottom" @submit.prevent="registration">
        <label style="width: 100%"><b>Логин</b>
          <div v-show="username && username.length < 5" class="w3-panel w3-pale-red">Логин должен содержать минимум 5
            символов
          </div>
        ...
        <label style="width: 100%"><b>Пароль</b>
          <div v-show="password && password.length < 5" class="w3-panel w3-pale-red">Пароль должен содержать минимум 5
            символов
          </div>
